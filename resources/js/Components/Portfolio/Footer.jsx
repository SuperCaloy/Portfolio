                    ...
                    {githubUrl && (
                        <a
                           href={githubUrl}
                            ...
                            aria-label="GitHub"
                            className="p-2 rounded-lg text-zinc-500 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 active:scale-90 transition-all"
                        >
