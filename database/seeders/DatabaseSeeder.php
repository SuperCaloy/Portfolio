    ...
    public function run(): void
    {
        ...
        $projects = [
            ...
            [
                ...
                'subtitle' => 'Short one line description',
                'description' => 'Full project description, features, and your role.',
                'tech_stack' => ['Laravel', 'Inertia', 'MySQL'],
                'demo_url' => null,
            ...
            [
                ...
                'subtitle' => 'Short one line description',
                'description' => 'Full project description, features, and your role.',
                'tech_stack' => ['PHP', 'MySQL', 'Docker'],
                'demo_url' => null,
                'github_url' => 'https://github.com/yourusername/project-four',
                'image_path' => 'projects/project4.jpg',
                'status' => 'Completed',
                'is_featured' => false,
                'sort_order' => 4,
            ],
            [
                ...
                'subtitle' => 'Short one line description',
                'description' => 'Full project description, features, and your role.',
                'tech_stack' => ['Laravel', 'Vue', 'TailwindCSS'],
                'demo_url' => null,
                'github_url' => 'https://github.com/yourusername/project-five',
                'image_path' => 'projects/project5.jpg',
                'status' => 'Archived',
                'is_featured' => false,
                'sort_order' => 5,
            ],
